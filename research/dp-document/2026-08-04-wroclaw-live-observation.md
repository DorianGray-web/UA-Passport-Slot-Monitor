# Wroclaw Public Discovery Live Observation

**Status:** User-provided live-observation evidence
**Observation date:** 2026-08-04
**Deployment:** Wroclaw, Poland
**Public page:** `https://wroclaw.pasport.org.ua/solutions/e-queue`
...
- 24 allowed public time entries;
- earliest observed time `10:45:00`;
- latest observed time `17:15:00`;
...
`available_time_slots_count` records 24 allowed time entries rather than
...
This observation independently confirms Wroclaw; it does not infer a rule for
