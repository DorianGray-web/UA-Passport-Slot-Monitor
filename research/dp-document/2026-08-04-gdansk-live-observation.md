# Gdansk Public Discovery Live Observation

**Status:** User-provided live-observation evidence
**Observation date:** 2026-08-04
**Deployment:** Gdansk, Poland
**Public page:** `https://gdansk.pasport.org.ua/solutions/e-queue`
...
- 29 allowed public time entries;
- earliest observed time `09:15:00`;
...
`available_time_slots_count` records 29 allowed time entries rather than
...
This observation independently confirms Gdansk; it does not infer a rule for
