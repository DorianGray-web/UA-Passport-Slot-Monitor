# Krakow Public Discovery Live Observation

**Status:** User-provided live-observation evidence
**Observation date:** 2026-08-04
**Deployment:** Krakow, Poland
**Public page:** `https://krakow.pasport.org.ua/solutions/e-queue`
...
- 30 allowed public time entries;
- earliest observed time `09:45:00`;
...
`available_time_slots_count` records 30 allowed time entries rather than
...
This observation independently confirms Krakow; it does not infer a rule for
