# Gdansk Public Discovery Profile Promotion — 2026-08-04

## Decision scope

This record evaluates Gdansk independently under
...
The retained owner-provided live review confirms centre `12`, service
`4`, one allowed date, 29 allowed time entries, and the bounded public
sequence `LANDING -> DAYS -> TIMES -> STOP`.

Evidence: [Gdansk live observation](../../research/dp-document/2026-08-04-gdansk-live-observation.md).
...
Approve `gdansk-v1` public discovery for centre `12`, service `4`.
