# Wroclaw Public Discovery Profile Promotion — 2026-08-04

## Decision scope

This record evaluates Wroclaw independently under
...
The retained owner-provided live review confirms centre `13`, service
`4`, one allowed date, 24 allowed time entries, and the bounded public
sequence `LANDING -> DAYS -> TIMES -> STOP`.

Evidence: [Wroclaw live observation](../../research/dp-document/2026-08-04-wroclaw-live-observation.md).
...
Approve `wroclaw-v1` public discovery for centre `13`, service `4`.
