# Krakow Public Discovery Profile Promotion — 2026-08-04

## Decision scope

This record evaluates Krakow independently under
...
The retained owner-provided live review confirms centre `11`, service
`4`, one allowed date, 30 allowed time entries, and the bounded public
sequence `LANDING -> DAYS -> TIMES -> STOP`.

Evidence: [Krakow live observation](../../research/dp-document/2026-08-04-krakow-live-observation.md).
...
Approve `krakow-v1` public discovery for centre `11`, service `4`.
