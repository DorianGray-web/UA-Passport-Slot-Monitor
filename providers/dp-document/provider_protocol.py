...
class EvidenceCode(StrEnum):
    ...
    EMBEDDED_CHALLENGE_ASSET_PRESENT = "EMBEDDED_CHALLENGE_ASSET_PRESENT"
    ACTIVE_CHALLENGE_GATE = "ACTIVE_CHALLENGE_GATE"
    CHALLENGE_INTERACTION_REQUIRED = "CHALLENGE_INTERACTION_REQUIRED"
    CHALLENGE_EFFECT_UNDETERMINED = "CHALLENGE_EFFECT_UNDETERMINED"
    FORM_STRUCTURE_COMPLETE = "FORM_STRUCTURE_COMPLETE"
    CHALLENGE_SOURCE_HTML_MARKER = "CHALLENGE_SOURCE_HTML_MARKER"
    CHALLENGE_SOURCE_CHALLENGE_FORM = "CHALLENGE_SOURCE_CHALLENGE_FORM"
    CHALLENGE_SOURCE_MAIN_FRAME_URL = "CHALLENGE_SOURCE_MAIN_FRAME_URL"
    CHALLENGE_SOURCE_IFRAME_DOCUMENT = "CHALLENGE_SOURCE_IFRAME_DOCUMENT"
    CHALLENGE_SOURCE_MIXED = "CHALLENGE_SOURCE_MIXED"
    PLAYWRIGHT_LEASE_TIMEOUT = "PLAYWRIGHT_LEASE_TIMEOUT"
